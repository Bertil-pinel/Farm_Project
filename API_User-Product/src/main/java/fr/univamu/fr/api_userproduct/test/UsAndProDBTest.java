...
import fr.univamu.fr.api_userproduct.UsAndRepoRepositoryDB;
...
public class UsAndProDBTest {
    ...
    public void getUserTest(){
        try {
            UsAndRepoRepositoryDB userDB = new UsAndRepoRepositoryDB("jdbc:mariadb://mysql-pinel-guinard.alwaysdata.net/pinel-guinard_user-products", "295723_user", "bertil123");
